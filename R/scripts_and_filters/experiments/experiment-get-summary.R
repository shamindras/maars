...
get_var_tidy_summary(mod_fit = mss_var1, sand = FALSE,
                     boot_emp = FALSE, boot_res = FALSE, boot_mul = FALSE,
                     well_specified = FALSE)

# res_sand_warn <- check_fn_args_summary(mod_fit = mss_var1, sand = FALSE,
#                                        boot_emp = FALSE, boot_res = FALSE, boot_mul = FALSE,
#                                        well_specified = FALSE)
# res_sand_warn
#
# res_sand_err <- check_fn_args_summary(mod_fit = mss_var1, sand = FALSE,
#                                       boot_emp = FALSE, boot_res = TRUE, boot_mul = FALSE,
#                                       well_specified = FALSE)
# res_sand_err
#
# res_sand_val <- check_fn_args_summary(mod_fit = mss_var1, sand = TRUE,
