#' ---
#' title: "Simulation inspired by [@hubbard2010togeeornotgee]"
...
#' vignette: >
#'   %\VignetteIndexEntry{Simulation inspired by [@hubbard2010togeeornotgee]}
...
#'+ create_chunk_options, include=FALSE
